          ...
          <div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border ${errors.password?.message ? "focus:border-red-500": "focus:border-green-600"} shadow-sm rounded-lg`}
                />
